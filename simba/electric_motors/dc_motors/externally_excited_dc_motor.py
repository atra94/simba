...
class ExternallyExcitedDCMotor(SystemComponent):
    ...
    def __init__(self, name: str = 'ExternallyExcitedDCMotor', parameter: dict or None = None):
        ...
        super().__init__(
            name, outputs=(current_output, anchor_current_output, exciting_current_output, torque_output),
    ...
    def compile(self, get_extra_index: Callable[[Any], int], numba_compile: bool = True):
        ...
        def ode(t, local_state, u, omega):
            return np.dot(
                model_parameter,
                nb.float64([
                    local_state[i_a_state_idx],
                    local_state[i_e_state_idx],
